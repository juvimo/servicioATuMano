...
const Mascot = ({ covering }) => (
  <div className={`login-mascot${covering ? " covering" : ""}`}>
    ...
    <div className="mascot-hand mascot-hand-l">
      <svg width="44" height="52" viewBox="0 0 46 55" fill="none">
      ...
      <div className="login-outer">
        ...
        <div className="login-card-light">
          <div className="text-center mb-3">
            ...
            <h2 className="login-title-light mb-1">Crear Cuenta</h2>
          ...
          {ok && (
            <div className="alert alert-success d-flex align-items-center gap-2 py-2 mb-2"
              style={{ fontSize: ".875rem", borderRadius: 10 }}>
              <span>✓</span> Registro exitoso. Revisa tu correo para confirmar tu cuenta.
            </div>
          )}
          ...
          <div className="text-center mt-2">
            <span style={{ color: "#64748b", fontSize: ".82rem" }}>¿Ya tienes cuenta? </span>
            <Link to="/login" style={{ color: "var(--primary)", fontWeight: 600, textDecoration: "none", fontSize: ".82rem" }}>
              Inicia sesión
            </Link>
          </div>
          <div className="text-center mt-2">
