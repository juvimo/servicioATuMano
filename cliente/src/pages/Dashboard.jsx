...
function Dashboard() {
  ...
  useEffect(() => { if (!usuario.email) navigate("/login"); }, []);
  useEffect(() => { if (seccion === "dashboard" || seccion === "servicios") cargarServicios(); }, [seccion]);
  ...
  const cerrarSesion = () => { sessionStorage.removeItem("usuario"); navigate("/"); };
